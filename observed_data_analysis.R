# This script was for perfoming the Cox regression with DLNM on the observed handball cohort.
# The code is not reproducible, as the data are not available in the GitHub Repository.
# THe code is only uploaded for the sake of transparency.
# The data are only available upon reasonable request.
...
# assuming data is in source file location
l_handball = readRDS("handball_imputed.RDS")
